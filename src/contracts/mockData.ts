...
export const MOCK_TASKS: Task[] = [
  {
    ...
    workerPreferredToken: TOKENS.EURC.address,
    state: "Funded",
  ...
  },
  {
    ...
    paymentToken: TOKENS.EURC.address,
...
export const MOCK_AUDIT_EVENTS: AuditEvent[] = [
  { id: 0, taskId: 0, action: "Task Created", actor: addresses[0], timestamp: now - 86400 * 3, txHash: "0xaaa111...", network: "Arc" },
  { id: 1, taskId: 0, action: "Task Funded", actor: addresses[0], timestamp: now - 86400 * 2, txHash: "0xaaa222...", network: "Arc" },
  { id: 2, taskId: 0, action: "Funding logged", actor: "HCS", timestamp: now - 86400 * 2, txHash: "0.0.12345@1234567890", network: "Hedera" },
  { id: 3, taskId: 1, action: "Work Submitted", actor: addresses[3], timestamp: now - 86400, txHash: "0xbbb111...", network: "Arc" },
  { id: 4, taskId: 1, action: "Submission logged", actor: "HCS", timestamp: now - 86400, txHash: "0.0.12345@1234567891", network: "Hedera" },
  { id: 5, taskId: 2, action: "Payout Completed", actor: addresses[4], timestamp: now - 86400 * 6, txHash: "0xccc111...", network: "Arc" },
  { id: 6, taskId: 4, action: "Work Verified", actor: addresses[3], timestamp: now - 3600, txHash: "0xddd111...", network: "Arc" },
